...
* The implementation of the features in the panel is not important here, just the panel itself (with static elements) and a link that opens a user's tracking info in a new tab.
...
As a basic user and general consumer who uses the extension once in a while to lookout for sales, I should not be forced to go through the registration process to make an account (out of pure convenience) because I don't use the extension enough to care about losing my data. 
...
### User story 17: Guest User Data Migration
...
### User story 18: Deleting an Item or Source from an Item
...
### User story 19: Recommended Sellers for an Item
...
### User story 20: Data Filtering and Sorting
...
### User story 21: Optional Item Photo
