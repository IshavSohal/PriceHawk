...
Your Mark: 2
  ...
  - Tasks Distribution (max 3 marks)
    ...
    Your Mark: 2 (some tasks don't have people assigned to them)
...
Tracking on Trello Total Mark: 19 / 20
...
## System Design (PDF or MD file or another suitable format) (max 10 marks) 
  ...
  - Software Architecture Diagram (max 4 marks)
    ...
    Your Mark: 1 (unclear what known architecture diagram is being followed)

    System Design Total Mark: 7 / 10
...
## Sprint Demo (Max 14 marks) 
  ...
  - 0 marks = documentation has not been created
      ...
      Your Mark: 1 (for future sprint demos, look into some sort of platform to host your docs, like swagger.ui or storybook, or putting it all in a google doc)
